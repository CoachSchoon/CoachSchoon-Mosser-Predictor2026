...
def _build_trends(sub):
    ...
    return trends, run_pct, pass_pct, pass_dir
...
def predict(dn=None, dist_group=None, hash_=None, yard_zone=None,
    ...
    if n >= MIN_SAMPLE:
        trends, run_pct, pass_pct, pass_dir = _build_trends(sub)
    ...
    if n2 >= MIN_SAMPLE:
        trends, run_pct, pass_pct, pass_dir = _build_trends(relaxed)
